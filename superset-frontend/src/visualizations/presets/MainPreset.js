...
import EchartsAggLineChartPlugin from 'src/echarts/visualizations/EchartsAggLine/EchartsAggLineChartPlugin';
  ...
  constructor() {
    super({
      ...
      plugins: [
        ...
        new EchartsAggLineChartPlugin().configure({ key: 'echarts_agg_line' }),
      ],
    });
  }
}
